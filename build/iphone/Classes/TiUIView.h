...
/**
 Base class for all paypalsample views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the paypalsample view hierarchy (such as wrapped iOS UIViews) was touched.
