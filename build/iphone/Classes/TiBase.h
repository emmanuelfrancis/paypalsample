...
// in simulator we redefine to format for paypalsample Developer console
...
{\
	NSString * exceptionName = [@"org.paypalsample." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.paypalsample";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIpaypalsampleNativeItemNone = -1, 
	UIpaypalsampleNativeItemSpinner = -2,
	UIpaypalsampleNativeItemProgressBar = -3,
	
	UIpaypalsampleNativeItemSlider = -4,
	UIpaypalsampleNativeItemSwitch = -5,
	UIpaypalsampleNativeItemMultiButton = -6,
	UIpaypalsampleNativeItemSegmented = -7,
	
	UIpaypalsampleNativeItemTextView = -8,
	UIpaypalsampleNativeItemTextField = -9,
	UIpaypalsampleNativeItemSearchBar = -10,
	
	UIpaypalsampleNativeItemPicker = -11,
	UIpaypalsampleNativeItemDatePicker = -12,
	
	UIpaypalsampleNativeItemInfoLight = -13,
	UIpaypalsampleNativeItemInfoDark = -14,
	
	UIpaypalsampleNativeItemDisclosure = -15,
	
	UIpaypalsampleNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all paypalsample instances of
