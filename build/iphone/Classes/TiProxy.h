...
//Rare exceptions to indicate a bug in the _paypalsample code (Eg, function that a subclass should have implemented)
...
/**
 The base class for paypalsample proxies.
 */
