...
@interface paypalsampleObject : KrollCoverageObject {
#else
@interface paypalsampleObject : KrollObject {
#endif
@private
...
extern NSString * paypalsample$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	paypalsampleObject *_paypalsample;
    KrollObject* console;
	BOOL shutdown;
