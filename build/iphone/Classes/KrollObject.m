...
//@interface paypalsampleObject : NSObject
//@end

@interface paypalsampleObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[paypalsampleObject class]])
		{
			for (NSString *key in [[(paypalsampleObject*)o modules] allKeys])
			{
